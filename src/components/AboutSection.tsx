      ...
      <div className="container px-4 md:px-6 space-y-10 max-w-5xl mx-auto">
        ...
        <DraggableWindow title="README.md" className="w-full">
          <div className="space-y-6 p-8 text-sm md:text-base leading-relaxed text-hl-muted font-sans">
            ...
            <p>
              I specialize in Next.js, TypeScript, and <span className="text-white font-bold">GenAI</span> integrations. I have extensive experience architecting secure, cloud-native web applications and delivering production-ready systems that solve real-world problems.
            </p>
            
            <div className="bg-white/5 p-4 rounded-lg border-l-2 border-hl-cyan">
        ...
        {/* 2. Stats Window (Bottom - Now Wider) */}
        <DraggableWindow title="stats.json" className="w-full">
          <div className="p-6">
            <h3 className="text-xs font-mono text-hl-muted mb-4 uppercase tracking-widest border-b border-white/5 pb-2">
